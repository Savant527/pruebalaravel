...
<div class=" bg-gray-900 px-20 py-16 rounded-l mb-8 relative overflow-hidden ">
<!--   Destacado -->
...
<p class="text-sm text-gray-400 mt-2">Proyecto desarrollo web para profesionales</p>
<img src="{{asset('img/dev.png')}}" class="absolute -right-1 -bottom-1 opacity-20 h-60">
</div>
